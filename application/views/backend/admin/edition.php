                                            ...
                                            <div class="table-responsive">
                                                <table id="user_data" class="table table-member ">
                                                    <thead class="tb-member-head thead-light">  
                                                        <tr>  
                                                            <th width="40%">Nom de de l'édution</th>  
    ...
    <!-- fin modal-->
     ...
     $(document).ready(function(){  
          $('#add_button').click(function(){  
               $('#user_form')[0].reset();  
               $('.modal-title').text("Paramètrage des éditions pour formation");  
               $('#action').val("Add");  
          })  
          ...
          var dataTable = $('#user_data').DataTable({  
               ...
               "order":[],  
               "ajax":{  
                    url:"<?php echo base_url() . 'admin/fetch_edition'; ?>",  
                    type:"POST"  
               },  
               "columnDefs":[  
                    {  
               ...
               if(nom != '')
                {
                  ...
                  if (action =="Add") {
                      ...
                      $.ajax({  
                           url:"<?php echo base_url() . 'admin/operation_edition'?>",  
                           method:'POST',  
                  ...
                  if (action == 'Edit') {
                        ...
                        $.ajax({  
                             url:"<?php echo base_url() . 'admin/modification_edition'?>",  
                             method:'POST',  
                             data:new FormData(this),  
                             contentType:false,  
                             processData:false,  
          ...
          $(document).on('click', '.update', function(){  
               ...
               $.ajax({  
                    url:"<?php echo base_url(); ?>admin/fetch_single_edition",  
                    method:"POST",  
          ...
          $(document).on('click', '.delete', function(){
              ...
              if(confirm("Are you sure you want to delete this?"))
	          {
	           		...
	           		$.ajax({
                      url:"<?php echo base_url(); ?>admin/supression_edition",
                      method:"POST",
                      data:{idedition:idedition},
                      success:function(data)
                      {
