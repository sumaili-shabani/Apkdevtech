				            ...
				            <div class="card direct-chat direct-chat-primary">
				              <div class="card-header bg-light">
				                ...
				                <div class="card-tools pull-right">
				                  ...
				                  <button type="button" class="btn btn-tool bg-white" data-card-widget="collapse">
				                    <i class="fa fa-minus"></i>
				                  </button>
				                  <button type="button" class="btn btn-tool bg-white" data-toggle="tooltip" title="Contacts"
				              ...
				              <div class="card-body">
				                ...
				                <div class="direct-chat-contacts" style="background-color: rgb(245, 246, 250);">
