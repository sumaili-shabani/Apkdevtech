                ...
                <div class="modal-body modal-body-lg">
                    ...
                    <div class="nk-block">
                        ...
                        <form method="post" id="user_form" enctype="multipart/form-data" class="col-md-12 row">
	                        ...
	                        <div class="form-group col-md-12">
                              <label><i class="fa fa-camera"></i> Selectionner l'image de service</label>
                    				...
                    				<div class="col-md-4">
                    					...
                    					<div class="buysell-field form-action text-center mb-2">
				                            <div>
				                            	...
				                            	<input type="hidden" name="idtinfo_service" id="idtinfo_service" />
    ...
    <script type="text/javascript">
     ...
     $(document).ready(function(){  
          $('#add_button').click(function(){  
               $('#user_form')[0].reset();  
               $('.modal-title').text("Paramètrage des informations de services");  
               $('#action').val("Add");  
          })  
          ...
          var dataTable = $('#user_data').DataTable({  
               ...
               "order":[],  
               "ajax":{  
                    url:"<?php echo base_url() . 'admin/fetch_tinfo_service'; ?>",  
                    type:"POST"  
               },  
               "columnDefs":[  
                    {  
               ...
               if(titre != '' && description != '')
                {
                  ...
                  if (action =="Add") {
                      ...
                      $.ajax({  
                           url:"<?php echo base_url() . 'admin/operation_tinfo_service'?>",  
                           method:'POST',  
                  ...
                  if (action == 'Edit') {
                        ...
                        $.ajax({  
                             url:"<?php echo base_url() . 'admin/modification_tinfo_service'?>",  
                             method:'POST',  
                             data:new FormData(this),  
                             contentType:false,  
                             processData:false,  
          ...
          $(document).on('click', '.update', function(){  
               var idtinfo_service = $(this).attr("idtinfo_service");  
               $.ajax({  
                    url:"<?php echo base_url(); ?>admin/fetch_single_tinfo_service",  
                    method:"POST",  
                    data:{idtinfo_service:idtinfo_service},  
                    dataType:"json",  
                    success:function(data)  
                    {  
                         ...
                         $('#idtinfo_service').val(idtinfo_service);   
                         $('#action').val("Edit");  
                    }  
               });  
          });
          ...
          $(document).on('click', '.delete', function(){
              ...
              if(confirm("Are you sure you want to delete this?"))
	          {
	           		...
	           		$.ajax({
                      url:"<?php echo base_url(); ?>admin/supression_tinfo_service",
                      method:"POST",
                      data:{idtinfo_service:idtinfo_service},
                      success:function(data)
                      {
