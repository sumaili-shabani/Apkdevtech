		                                            ...
		                                            <div class="table-responsive">
		                                                <table id="user_data" class="table table-member ">
		                                                    <thead class="tb-member-head thead-light">  
		                                                        <tr>  
		                                                            <th width="35%">Titre du choix</th>  
		                                                            <th width="30%">Description du choix</th>
		                                                            <th width="5%">icone</th>
                    ...
                    <div class="nk-block">
                        ...
                        <form method="post" id="user_form" enctype="multipart/form-data" class="col-md-12 row">
                        	...
                        	<div class="form-group col-md-12">
                        		<label><i class="fa fa-tag"></i> Titre du choix</label>
	                        ...
	                        <div class="form-group jf-inputwithicon col-md-12">
	                            <label><i class="fa fa-pencil"></i> Description du choix</label>
	                            <textarea class="form-control" name="description" id="description" placeholder="Description du choix"></textarea>
	                        </div>
	                        <!-- fin ajout -->

	                        <div class="form-group col-md-12">
                        		<label><i class="fa fa-git"></i> Icone du choix</label>
                    				...
                    				<div class="col-md-4">
                    					...
                    					<div class="buysell-field form-action text-center mb-2">
				                            <div>
				                            	...
				                            	<input type="hidden" name="idtinfo_choix" id="idtinfo_choix" />
    ...
    <script type="text/javascript">
     ...
     $(document).ready(function(){  
          $('#add_button').click(function(){  
               $('#user_form')[0].reset();  
               $('.modal-title').text("Paramètrage des informations du choix");  
               $('#action').val("Add");  
          })  
          ...
          var dataTable = $('#user_data').DataTable({  
               ...
               "order":[],  
               "ajax":{  
                    url:"<?php echo base_url() . 'admin/fetch_tinfo_choix'; ?>",  
                    type:"POST"  
               },  
               "columnDefs":[  
                    {  
               ...
               if(titre != '' && description != '' && icone != '')
                {
                  ...
                  if (action =="Add") {
                      ...
                      $.ajax({  
                           url:"<?php echo base_url() . 'admin/operation_tinfo_choix'?>",  
                           method:'POST',  
                  ...
                  if (action == 'Edit') {
                        ...
                        $.ajax({  
                             url:"<?php echo base_url() . 'admin/modification_tinfo_choix'?>",  
                             method:'POST',  
                             data:new FormData(this),  
                             contentType:false,  
                             processData:false,  
          ...
          $(document).on('click', '.update', function(){  
               var idtinfo_choix = $(this).attr("idtinfo_choix");  
               $.ajax({  
                    url:"<?php echo base_url(); ?>admin/fetch_single_tinfo_choix",  
                    method:"POST",  
                    data:{idtinfo_choix:idtinfo_choix},  
                    dataType:"json",  
                    success:function(data)  
                    {  
                         ...
                         $('#idtinfo_choix').val(idtinfo_choix);   
                         $('#action').val("Edit");  
                    }  
               });  
          });
          ...
          $(document).on('click', '.delete', function(){
              ...
              if(confirm("Are you sure you want to delete this?"))
	          {
	           		...
	           		$.ajax({
                      url:"<?php echo base_url(); ?>admin/supression_tinfo_choix",
                      method:"POST",
                      data:{idtinfo_choix:idtinfo_choix},
                      success:function(data)
                      {
