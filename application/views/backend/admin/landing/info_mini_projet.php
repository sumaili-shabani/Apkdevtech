                ...
                <div class="modal-body modal-body-lg">
                    ...
                    <div class="nk-block">
                        ...
                        <form method="post" id="user_form" enctype="multipart/form-data" class="col-md-12 row">
	                        ...
	                        <div class="form-group col-md-12">
                        		<label><i class="fa fa-tag"></i> Le prix à louer de l'application</label>
                        		<input type="number" min="0" name="montant" id="montant" class="form-control montant" placeholder="Entrez le prix à louer en $">
                        	</div>
                    				...
                    				<div class="col-md-4">
                    					...
                    					<div class="buysell-field form-action text-center mb-2">
				                            <div>
				                            	...
				                            	<input type="hidden" name="idtinfo_projet_mini" id="idtinfo_projet_mini" />
    ...
    <script type="text/javascript">
     ...
     $(document).ready(function(){  
               ...
               if(titre != '' && description != '' && montant != '')
                {
                  ...
                  if (action =="Add") {
                      ...
                      $.ajax({  
                           url:"<?php echo base_url() . 'admin/operation_tinfo_projet_mini'?>",  
                           method:'POST',  
                  ...
                  if (action == 'Edit') {
                        ...
                        $.ajax({  
                             url:"<?php echo base_url() . 'admin/modification_tinfo_projet_mini'?>",  
                             method:'POST',  
                             data:new FormData(this),  
                             contentType:false,  
                             processData:false,  
          ...
          $(document).on('click', '.update', function(){  
               var idtinfo_projet_mini = $(this).attr("idtinfo_projet_mini");  
               $.ajax({  
                    url:"<?php echo base_url(); ?>admin/fetch_single_tinfo_projet_mini",  
                    method:"POST",  
                    data:{idtinfo_projet_mini:idtinfo_projet_mini},  
                    dataType:"json",  
                    success:function(data)  
                    {  
                         ...
                         $('.modal-title').text("modification des informations du mini projet "+data.titre);  
                         $('#idtinfo_projet_mini').val(idtinfo_projet_mini);   
                         $('#action').val("Edit");  
                    }  
               });  
          });
          ...
          $(document).on('click', '.delete', function(){
              ...
              if(confirm("Are you sure you want to delete this?"))
	          {
	           		...
	           		$.ajax({
                      url:"<?php echo base_url(); ?>admin/supression_tinfo_projet_mini",
                      method:"POST",
                      data:{idtinfo_projet_mini:idtinfo_projet_mini},
                      success:function(data)
                      {
