                   	...
                   	<?php 
	                   	if ($donnees->num_rows() > 0) {
	                   		foreach ($donnees->result_array() as $key) {
	                   			...
	                   			<tr>
	                   				<td>
	                   					<a href="<?php echo(base_url()) ?>admin/impression_pdf_paiemant_list/<?php echo($key['idp']) ?>" class="btn btn-primary btn-xs"><i class="fa fa-print"></i></a>
	                   				</td>
	                   				...
	                   				<td>
	                   					<a href="javascript:void(0);" class="btn btn-warning update btn-xs"  idp="<?php echo($key['idp']) ?>"><i class="fa fa-edit"></i></a>
	                   				</td>
