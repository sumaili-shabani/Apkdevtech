                                            ...
                                            <div class="table-responsive">
                                                <table id="user_data" class="table table-member ">
                                                    <thead class="tb-member-head thead-light">  
                                                        <tr>  
                                                            <th width="40%">Nom de de la catégorie</th>  
            ...
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-lg">
                    <div class="nk-block-head nk-block-head-xs text-center">
                        <span class="nk-block-title modal-title">Paramètrage des éditions</span>
                    	...
                    	<form method="post" id="user_form" enctype="multipart/form-data" class="col-md-12 row">
                    		...
                    		<div class="col-md-12">
                    			<div class="input-group flex-nowrap mb-2">
  								  ...
  								  <input type="text" name="nom" id="nom" class="form-control" placeholder="Entrez le nom de la catégorie" />
  								</div>
                    		</div>
    ...
    <!-- fin modal-->
     ...
     $(document).ready(function(){  
          $('#add_button').click(function(){  
               $('#user_form')[0].reset();  
               $('.modal-title').text("Paramètrage des catégories des apprenants");  
               $('#action').val("Add");  
          })  
          ...
          var dataTable = $('#user_data').DataTable({  
               ...
               "order":[],  
               "ajax":{  
                    url:"<?php echo base_url() . 'admin/fetch_categorie_aprenant'; ?>",  
                    type:"POST"  
               },  
               "columnDefs":[  
                    {  
               ...
               if(nom != '')
                {
                  ...
                  if (action =="Add") {
                      ...
                      $.ajax({  
                           url:"<?php echo base_url() . 'admin/operation_categorie_aprenant'?>",  
                           method:'POST',  
                  ...
                  if (action == 'Edit') {
                        ...
                        $.ajax({  
                             url:"<?php echo base_url() . 'admin/modification_categorie_aprenant'?>",  
                             method:'POST',  
                             data:new FormData(this),  
                             contentType:false,  
                             processData:false,  
          ...
          $(document).on('click', '.update', function(){  
               ...
               $.ajax({  
                    url:"<?php echo base_url(); ?>admin/fetch_single_categorie_aprenant",  
                    method:"POST",  
                    data:{idcat:idcat},  
                    dataType:"json",  
                    success:function(data)  
          ...
          $(document).on('click', '.delete', function(){
              ...
              if(confirm("Are you sure you want to delete this?"))
	          {
	           		...
	           		$.ajax({
                      url:"<?php echo base_url(); ?>admin/supression_categorie_aprenant",
                      method:"POST",
                      data:{idcat:idcat},
                      success:function(data)
                      {
