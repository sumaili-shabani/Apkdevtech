        ...
        <?php
         ...
         if ($message->num_rows() > 0) {
          ...
          foreach ($message->result_array() as $not) {
            ...
            <div class="col-md-12 media text-muted pt-1">

                <img alt="avatar" class="img img-cirle" src="<?php echo(base_url()) ?>upload/photo/<?php echo($not['image']) ?>" style="width: 40px; height: 40px; border-radius: 60%;"> &nbsp;&nbsp;
