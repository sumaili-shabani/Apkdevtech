                ...
                <div class="nk-ibx-item-elem nk-ibx-item-tools">
                    <div class="ibx-actions">
                        <ul class="ibx-actions-hidden gx-1">
                            <li>
                                <a href="<?php echo(base_url()) ?>user/chat_admin/<?php echo($id) ?>/<?php echo($not['id_user']) ?>" class="btn btn-sm btn-icon btn-trigger" data-toggle="tooltip" data-placement="top" title="Archive"><em class="icon ni ni-archived"></em></a>
                            </li>
                            <li>
                                <a onclick="return confirm('Etes-vous sûre de vouloire Supprimer ce message?')" href="<?php echo(base_url()) ?>user/view_1/display_delete_message/<?php echo($id) ?>/<?php echo($not['idmessage']) ?>" class="btn btn-sm btn-icon btn-trigger" data-toggle="tooltip" data-placement="top" title="Delete"><em class="icon ni ni-trash"></em></a>
                            </li>
                        </ul>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <ul class="link-list-opt no-bdr">
                                            ...
                                            <li><a class="dropdown-item" href="<?php echo(base_url()) ?>user/chat_admin/<?php echo($id) ?>/<?php echo($not['id_user']) ?>"><em class="icon ni ni-eye"></em><span>Voir</span></a></li>

                                            <li><a class="dropdown-item" onclick="return confirm('Etes-vous sûre de vouloire Supprimer ce message?')" href="<?php echo(base_url()) ?>user/view_1/display_delete_message/<?php echo($id) ?>/<?php echo($not['idmessage']) ?>"><em class="icon ni ni-trash"></em><span>Supprimer</span></a></li>
