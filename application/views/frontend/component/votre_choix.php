<div class="col-md-12 mb-2">
    <div class="row">
            		...
            		<div class="row">
            			...
            			<?php 
	                        ...
	                        ';
	                         ...
	                         $nb5 = ' 
	                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90" style="height: 50px;">
                                <rect x="12" y="5" width="55" height="68" rx="6" ry="6" fill="#e3e7fe" stroke="#6576ff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></rect>
                                <path d="M78,15.8l-5.72,6.33L66.7,16l-5.33,5.91-5.82-6.46L49.67,22,44.13,15.8l-5.49,6.09L33,15.62,27.27,22l-6.16-6.83L21,15V79c0,3.33,2.43,6,5.43,6H72.57c3,0,5.43-2.69,5.43-6V15.76S77.94,15.79,78,15.8Z" fill="#fff" stroke="#6576ff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path>
                                <circle cx="49.5" cy="35.5" r="2.5" fill="#c4cefe" stroke="#c4cefe" stroke-miterlimit="10" stroke-width="2"></circle>
                                <line x1="71" y1="50" x2="28" y2="49.86" fill="none" stroke="#c4cefe" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></line>
                                <line x1="71" y1="56" x2="28" y2="55.86" fill="none" stroke="#c4cefe" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></line>
                                <line x1="71" y1="61" x2="28" y2="60.86" fill="none" stroke="#c4cefe" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></line>
                                <line x1="28" y1="45" x2="38" y2="45" fill="none" stroke="#c4cefe" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></line>
                                <line x1="61" y1="45" x2="71" y2="45" fill="none" stroke="#c4cefe" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></line>
                                <line x1="28" y1="76" x2="41" y2="76" fill="none" stroke="#c4cefe" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></line>
                                <line x1="61" y1="76" x2="69" y2="76" fill="none" stroke="#c4cefe" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></line>
                                <line x1="59" y1="66" x2="69" y2="66" fill="none" stroke="#c4cefe" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></line>
                              </svg>
	                        ';
	                        ...
	                        if ($services_choix->num_rows() > 0) {
	                        	foreach ($services_choix->result_array() as $key) {

	                        		if ($key['idtinfo_choix'] == 1) {
	                        			$icone_service_ok = $nb1;
	                        		}
	                        		elseif ($key['idtinfo_choix'] == 2) {
	                        			$icone_service_ok = $nb2;
	                        		}
	                        		elseif ($key['idtinfo_choix'] == 3) {
	                        			$icone_service_ok = $nb3;
	                        		}
	                        		elseif ($key['idtinfo_choix'] == 4) {
	                        			$icone_service_ok = $nb4;
	                        		}
	                        		elseif ($key['idtinfo_choix'] == 5) {
	                        			$icone_service_ok = $nb5;
	                        		}
	                        		else{
	                        			$icone_service_ok = $nb6;
	                        		}
					                ...
					                <div class="col-md-6 mb-2">
				                        ...
				                        <div class="card-bordered">
				                        	<div class="card-header">
				                        		<div class="card-title text-center" style="height: 35px;">
				                        			<i class="fa <?php echo($key['icone']) ?>"></i>&nbsp; <?php echo($key['titre']) ?>
				                        		</div>
				                        	</div>
        ...
        <!-- img services -->
        <div class="col-md-4">
            <img src="<?php echo(base_url()) ?>upload/carousel/eleve 2.jpg" style="margin-top: 120px;">
        </div>
        <!-- fin services -->
